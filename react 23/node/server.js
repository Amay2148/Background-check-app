...
app.put('/change-password/:id', resetAuth, async (req, res, next) => {
    console.log("ghghghgh", req)
    const { password, password2 } = req.body;
    console.log("password1225", password);
    console.log("passwofhzh", password2);
    if (!password || !password2 || (password2 != password)) {
        ...
        if (salt) {
            ...
            res.status(200).json({ message: "password update sucesss" })
...
app.put('/reset-password/:id', async (req, res, next) => {
    ...
    console.log("password1225", password1);
    console.log("passwofhzh", password2);
